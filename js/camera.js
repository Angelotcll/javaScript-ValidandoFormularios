const botoaIniciarCamera = document.querySelector("[data-video-botao]");
...
botoaIniciarCamera.addEventListener("click", async function () {
  const iniciarVideo = await navigator.mediaDevices.getUserMedia({
    video: true,
    audio: false,
  });

  botoaIniciarCamera.style.display = "none";
